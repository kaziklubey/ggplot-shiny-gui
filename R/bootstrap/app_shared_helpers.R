...
# Live Graph/Figure previews are static images: the application does not use
# plotOutput click/hover/brush coordinates. Draw ggplot objects explicitly as
# grid grobs and return an invisible NULL so Shiny uses its generic/base image
# coordmap instead of attempting ggplot panel-coordinate extraction. This keeps
# the image payload valid across Shiny/ggplot2 versions (notably Shiny 1.13 +
# ggplot2 4.x) without changing the rendered plot or export path.
app_draw_static_plot <- function(plot) {
