...
# Section: HELPERS-BEGIN
  ...
  # Bar/Box only: semantic no-fill flags keyed by Color/Fill variable and level.
  # Palette colours stay in color_styles so border=fill and other aesthetics keep
  # the original colour even when the Bar/Box interior is intentionally empty.
  fill_none_styles <- reactiveVal(list())
