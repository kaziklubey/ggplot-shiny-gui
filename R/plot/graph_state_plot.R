...
graph_plot_calculation <- parse("R/plot/calculation/graph_plot_calculation.R", encoding = "UTF-8")
graph_plot_data_definitions <- parse("R/plot/calculation/graph_plot_data_calculation.R", encoding = "UTF-8")
graph_state_plot_definitions <- parse("R/plot/calculation/graph_state_plot_helpers.R", encoding = "UTF-8")
...
graph_snapshot_input_defaults <- function() {
  list(
    ...
    mean_color_mode = "#000000", bar_fill_none_fixed = FALSE,
    mean_linetype = "solid", mean_shape = 16,
    ...
    bar_border_linetype = "solid", bar_border_dash = 4, bar_border_gap = 2,
    ...
    legend_fill_show = TRUE, legend_merge_mode = "auto",
    legend_colour_title_show = FALSE, legend_fill_title_show = FALSE,
    legend_linetype_title_show = FALSE, legend_shape_title_show = FALSE,
    legend_colour_title = "", legend_fill_title = "",
    legend_linetype_title = "", legend_shape_title = "",
    legend_colour_order = 1L, legend_fill_order = 2L,
    legend_linetype_order = 3L, legend_shape_order = 4L,
    ...
    legend_wrap_mode = "auto", legend_wrap_count = 2L,
    legend_item_spacing = -1, legend_text_size = 0,
...
graph_snapshot_context <- function(state) {
  ...
  # R/plot/calculation/graph_plot_calculation.R is shared with the live Graph Editor, where
  ...
  for (name in c("color_styles", "fill_none_styles", "linetype_styles", "shape_styles", "series_styles",
