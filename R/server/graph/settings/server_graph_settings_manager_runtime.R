...
# settings runtimes sourced after this file.
  ...
  graph_settings_manager_rows <- function() {
    ...
    list(
      ...
      list(group="凡例", label="塗り凡例を表示", path="style.appearance.legend_fill_show", section="legend", input="legend_fill_show", apply=TRUE, editor=editor_boolean()),
      ...
      list(group="凡例", label="同じ変数の凡例", path="style.appearance.legend_merge_mode", section="legend", input="legend_merge_mode", apply=TRUE,
           editor=editor_select(c("auto","separate"), c("自動で統合","別々に表示"))),
      list(group="凡例", label="色凡例タイトルを表示", path="style.appearance.legend_colour_title_show", section="legend", input="legend_colour_title_show", apply=TRUE, editor=editor_boolean()),
      list(group="凡例", label="色凡例タイトル", path="style.appearance.legend_colour_title", section="legend", input="legend_colour_title", apply=TRUE, editor=editor_text()),
      list(group="凡例", label="色凡例順", path="style.appearance.legend_colour_order", section="legend", input="legend_colour_order", apply=TRUE, editor=editor_select(as.character(1:4), as.character(1:4))),
      list(group="凡例", label="塗り凡例タイトルを表示", path="style.appearance.legend_fill_title_show", section="legend", input="legend_fill_title_show", apply=TRUE, editor=editor_boolean()),
      list(group="凡例", label="塗り凡例タイトル", path="style.appearance.legend_fill_title", section="legend", input="legend_fill_title", apply=TRUE, editor=editor_text()),
      list(group="凡例", label="塗り凡例順", path="style.appearance.legend_fill_order", section="legend", input="legend_fill_order", apply=TRUE, editor=editor_select(as.character(1:4), as.character(1:4))),
      list(group="凡例", label="線種凡例タイトルを表示", path="style.appearance.legend_linetype_title_show", section="legend", input="legend_linetype_title_show", apply=TRUE, editor=editor_boolean()),
      list(group="凡例", label="線種凡例タイトル", path="style.appearance.legend_linetype_title", section="legend", input="legend_linetype_title", apply=TRUE, editor=editor_text()),
      list(group="凡例", label="線種凡例順", path="style.appearance.legend_linetype_order", section="legend", input="legend_linetype_order", apply=TRUE, editor=editor_select(as.character(1:4), as.character(1:4))),
      list(group="凡例", label="点形状凡例タイトルを表示", path="style.appearance.legend_shape_title_show", section="legend", input="legend_shape_title_show", apply=TRUE, editor=editor_boolean()),
      list(group="凡例", label="点形状凡例タイトル", path="style.appearance.legend_shape_title", section="legend", input="legend_shape_title", apply=TRUE, editor=editor_text()),
