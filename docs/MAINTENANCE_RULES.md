...
8. **Keep transaction code separate from pure transformation code.** Restore/sync/render lifecycle may remain reactive, but parsing, normalization, validation, mapping contracts and plot preparation should be ordinary functions.
